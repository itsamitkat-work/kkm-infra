...
export type CellOpts =
  ...
  | {
      variant: 'item-autocomplete';
      /** Map grid columnId -> MasterProjectItem key to fill on select (e.g. description -> 'name') */
      fillColumns?: Record<string, string>;
    }
  | {
      variant: 'item-or-material-select';
      /** Map grid columnId -> item/material key to fill on select (e.g. description -> 'name') */
      fillColumns?: Record<string, string>;
    };
