...
function DataGridRowImpl<TData>({
  ...
  const getRowClassName = (tableMeta as { getRowClassName?: (row: TData) => string | undefined })
    ?.getRowClassName;
    ...
    >
      {visibleCells.map((cell, colIndex) => {
        ...
        const columnReadOnly =
          (cell.column.columnDef.meta as { readOnly?: boolean } | undefined)
            ?.readOnly ?? false;
        const isCellReadOnly = readOnly || columnReadOnly;
        ...
        return (
          <div
            ...
            className={cn(
              {
                grow:
                  (stretchColumns && columnId !== 'select') ||
                  cell.column.columnDef.meta?.flex === true,
            ...
            {typeof cell.column.columnDef.header === 'function' ? (
              <div
                className={cn('size-full', {
                  ...
                  'px-1.5 py-0.5': rowHeight === 'compact',
                  'px-3 py-1.5': rowHeight !== 'compact',
                })}
              >
