...
import {
  ...
  DateCell,
  FileCell,
  ItemCodeAutocompleteCell,
  ItemOrMaterialSelectCell,
  LongTextCell,
  MultiSelectCell,
  NumberCell,
  SelectCell,
...
function DataGridCellImpl<TData>({
  ...
  switch (variant) {
    ...
    case 'item-autocomplete':
      Comp = ItemCodeAutocompleteCell;
      break;
    case 'item-or-material-select':
      Comp = ItemOrMaterialSelectCell;
      break;
