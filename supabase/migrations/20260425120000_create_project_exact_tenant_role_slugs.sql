-- Project member role keys in p_members_by_slug match authz.tenant_roles.slug exactly
-- (project_maker, project_checker, …). No legacy supervisor / superviser alias resolution.
