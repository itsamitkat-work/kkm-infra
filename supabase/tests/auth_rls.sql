...
-- The test data above already assigns members.manage to the engineer_role.
...
-- Insert test: user has members.manage via role_permissions in the DB
select lives_ok(
  ...
  'Insert works — members.manage resolved from DB role_permissions'
);
